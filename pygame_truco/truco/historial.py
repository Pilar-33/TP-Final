...
def guardar_resultado_partida(
    ...
    modo_juego: int, archivo: str = "historial.csv"
    ) -> None:
...
def mostrar_ranking_jugadores() -> None:
    ...
    for pos, jugador in enumerate(ranking, 1):
        print(f"{pos}. {jugador['nombre']} - {('⭐' if jugador['victorias'] > jugador['partidas']/2 else '❌')} {jugador['victorias']} victorias")
    print("───────────────────────────────────")


    
def mostrar_historial_personal(nombre_jugador: str) -> None:
    print(f"\n⭐ RANKING PERSONAL DE {nombre_jugador.upper()} ⭐")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
